...
class PreviewModal extends Component {
    // Fallback for missing data and utility methods can go here if needed
                    ...
                    <div className="form-group">
                        ...
                        {record.nearMatchInBlock ? (
                            <>
                                ...
                                <DataTable
                                    data={blockDetails}
                                    headers={["Column 1", "Column 2", "Column 3"]} // Replace with actual headers
                        ...
                        {(allocationDetails.length > 0 && (record.SSCInvestmentType === 'TRPO' || record.SSCInvestmentType === 'XYZ')) ? (
                            <>
                                ...
                                <DataTable
                                    ...
                                    headers={["Allocation 1", "Allocation 2", "Allocation 3"]} // Replace with actual headers
                        ...
                        {mktShpeList.length > 0 ? (
                            <>
                                ...
                                <DataTable
                                    data={mktShpeList}
                                    headers={["Market Shape 1", "Market Shape 2"]} // Replace with actual headers
                                    boldCondition={(index) => this.getBoldCondition(index)}
                                />
                            </>
                        ) : null}
